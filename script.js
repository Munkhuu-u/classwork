...
function drawtodo() {
  ...
  if (selectS.value == "In progress") {
    // duplicate this section after array changing bug cleared
    let todoes = document.getElementById("todoes1"); //ali div dotor baigaagaas hamaarch Id ni oorchlogdono
    todoes.className = "todoes";
    todoes.innerHTML = "";
    ...
    for (let i = 0; i < inprogArr.length; i++) {
      let todo = document.createElement("div");
      let p1 = document.createElement("p");
      let p2 = document.createElement("p");
      todo.setAttribute("class", "todo");
      ...
      tododelbutt.innerText = "Delete";
      tododelbutt.id = `${inprogArr[i].id}`; //change id value with array name
      tododelbutt.addEventListener("click", (e) => {
        let id = e.target.id;
        // console.log(e.target);
        deleteTodo(id);
      ...
      todoeditbutt.innerText = "Edit";
      todoeditbutt.id = `inpr${i}`; //change id value with array name
      todoeditbutt.addEventListener("click", (e) => {
        let id = e.target.id;
        editTodo(id);
      });

      p1.innerText = inprogArr[i].Title;
      p2.innerText = inprogArr[i].Description;
      todoPrior.innerText = inprogArr[i].Priority;
  ...
  //stuck-g zurj baigaa
  if (selectS.value == "Stuck") {
    // duplicate this section after array changing bug cleared
    let todoes = document.getElementById("todoes2"); //ali div dotor baigaagaas hamaarch Id ni oorchlogdono
    todoes.className = "todoes";
    todoes.innerHTML = "";
    ...
    for (let i = 0; i < stuckArr.length; i++) {
      ...
      tododelbutt.innerText = "Delete";
      tododelbutt.id = `${stuckArr[i].id}`; //change id value with array name
      tododelbutt.addEventListener("click", (e) => {
        let id = e.target.id;
        deleteTodo(id);
      });
      ...
      todoeditbutt.innerText = "Edit";
      todoeditbutt.id = `Stuc${i}`; //change id value with array name
      todoeditbutt.addEventListener("click", (e) => {
        let id = e.target.id;
        editTodo(id);
      });

      p1.innerText = stuckArr[i].Title;
      p2.innerText = stuckArr[i].Description;
      todoPrior.innerText = stuckArr[i].Priority;
  ...
  //Done-g zurj baigaa
  if (selectS.value == "Done") {
    // duplicate this section after array changing bug cleared
    let todoes = document.getElementById("todoes3"); //ali div dotor baigaagaas hamaarch Id ni oorchlogdono
    todoes.className = "todoes";
    todoes.innerHTML = "";
    for (let i = 0; i < doneArr.length; i++) {
      ...
      tododelbutt.innerText = "Delete";
      tododelbutt.id = `${doneArr[i].id}`; //change id value with array name
      tododelbutt.addEventListener("click", (e) => {
        let id = e.target.id;
        deleteTodo(id);
      });
      ...
      todoeditbutt.innerText = "Edit";
      todoeditbutt.id = `Done${i}`; //change id value with array name
      todoeditbutt.addEventListener("click", (e) => {
        let id = e.target.id;
        editTodo(id);
      });

      p1.innerText = doneArr[i].Title;
      p2.innerText = doneArr[i].Description;
      todoPrior.innerText = doneArr[i].Priority;
...
function addTaskButtF() {
  ...
  if (putindex == -1) {
    ...
    if (selectS.value == "To do") {
      ...
      receiver.id = `Stuc${stuckArr.length}`;
